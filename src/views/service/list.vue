<template>
  <div class="app-container">
    ...
    <el-dialog title="开发中" :visible.sync="dev">
      <div style="text-align: center"><img src="https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif"><p style="font-size:40px">building...</p></div>
    </el-dialog>
